DateInput = (function($) {
	...
	DateInput.prototype = {
		...
		show: function() {
			...
			$(obj).parents(".wqdelementEdit").css("zIndex",9999);
		...
		hide: function() {
			...
			$(obj).parents(".wqdelementEdit").each(function(){
				$(this).css("zIndex",$(this).attr("data-zindex")||0);
			});
			$(obj).parents('section.sectionV2').css({'zIndex':5,'overflow':'hidden'});
